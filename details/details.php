        ...
        <hr>
            ...
            <div id="email-us" class="email-us">
                ...
                <form action="../connections/mailto.php" method="post">
                        ...
                        <li>
                            <a href="#" class="_u2c">
                                <img src="../resources/socialmedia/icons8-instagram-48.png" style="width: 24px;" alt="instagram">
                            </a>
                        </li>
                        <li><a href="#" class="_u2c">
                            <img src="../resources/socialmedia/icons8-facebook-48.png" style="width: 24px;" alt="facebook">
                        </a></li>
                        <li><a href="#" class="_u2c">
                            <img src="../resources/socialmedia/icons8-pinterest-48.png" style="width: 24px;" alt="pinterest">
                        </a></li>
                        <li><a href="#" class="_u2c">
                            <img src="../resources/socialmedia/icons8-twitterx-50.png" style="width: 24px;" alt="twitter X">
                        </a></li>
                        </ul>
                </form>
